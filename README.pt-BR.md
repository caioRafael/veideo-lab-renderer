...
O pacote publicado expõe `dist/`. Consumo via `file:` (playground) precisa do `pnpm build` neste repo. Publicar no npm: [docs/pt-BR/publishing.md](docs/pt-BR/publishing.md).

Contrato completo da API: [docs/pt-BR/api.md](docs/pt-BR/api.md).
...
Contrato, tipos e defaults: [docs/pt-BR/api.md](docs/pt-BR/api.md). Sources: [docs/pt-BR/assets.md](docs/pt-BR/assets.md).
...
Detalhes: [docs/pt-BR/assets.md](docs/pt-BR/assets.md).
...
A tradução para filtros acontece só no `FfmpegCommandBuilder`. O RenderPlan guarda `incomingTransition` (`type` + `duration`), sem sintaxe FFmpeg. Detalhes do filter graph: [docs/pt-BR/ffmpeg-guide.md](docs/pt-BR/ffmpeg-guide.md).
...
- [docs/pt-BR/api.md](docs/pt-BR/api.md) — API pública (`render`, `parseComposition`, resultado)
- [docs/pt-BR/assets.md](docs/pt-BR/assets.md) — sources (`file`, `asset`, `url`) e mapa `assets`
- [docs/pt-BR/publishing.md](docs/pt-BR/publishing.md) — publicar no npm pelo GitHub
- [docs/pt-BR/render-pipeline.md](docs/pt-BR/render-pipeline.md) — ciclo de vida do render
- [docs/pt-BR/progress.md](docs/pt-BR/progress.md) — callback de progresso
- [docs/pt-BR/cancellation.md](docs/pt-BR/cancellation.md) — AbortSignal e cleanup
- [docs/pt-BR/performance.md](docs/pt-BR/performance.md) — render factor
- [docs/pt-BR/flow-create-video.md](docs/pt-BR/flow-create-video.md) — como o JSON vira comando FFmpeg
- [docs/pt-BR/ffmpeg-guide.md](docs/pt-BR/ffmpeg-guide.md) — flags, filtros e o filter graph
